...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            ...
            noMatch: "<button class='btn btn-success' type='button' onclick=$('#Assigned')[0].sumo.add('{0}',0);><b>If Not found (Add):</b> '{0}'</button>",
            //noMatch: "<button class='btn btn-success' type='button' onclick=$('select.SlectBox')[0].sumo.add('{0}',0);><b>Not found Add:</b> '{0}'</button>",
            //noMatch: "<input type='button' class='btn btn-success' type='button' onclick=$('.SlectBox')[0].sumo.add('{0}',0);' value='Not found Add: {0}'/>",
